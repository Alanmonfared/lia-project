...
import { GlobalDispatcher, GlobalStates } from "../../Contexts/GlobalState";
    ...
    <Container>
      <GridCard>
        <Item>
          ...
          <H1Grid>{removeDash(props.game.slug)} </H1Grid>
          ...
          {added() ? (
            ...
            <GridButton
              onClick={add}
              style={{ border: "1px solid gray", background: "lightgreen" }}
            >
              Add to favorite
            </GridButton>
          )}
